                        ...
                        <form action="{{ url('admin/tailorFormAction') }}" id="course_form" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Last Name" name="last_name" onkeyup="value=value.replace(/[^\a-\z\A-\Z ]/g,'')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Mobile Number" name="mobile_number" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" title="Only numbers are allowed" maxlength="12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Zip Code" name="user_zipcode" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                </div>
                                <!-- <div class="col-md-6">
