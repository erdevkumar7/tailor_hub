        ...
        <div class="row product-detail-page">
            <div class="col-lg-6 product-summary-left">
                ...
                <div class="main-product-image">
                    <img id="main-product-image" src="{{ url('public/Productupload', $product->product_image) }}"
                        alt="Main Product" class="" />
                </div>
                    ...
                    <div class="row product-images-inner">
                        <div class="col-3 one related-product-one">
                            <a href="javascript:void(0);">
                                <img src="{{ url('public/Productupload', $product->product_image) }}"
                                    alt="Related Product 1" class="related-product-img" />
                            </a>
                        </div>
                        @if (!empty($productImages) && count($productImages) > 0)
                            @foreach ($productImages as $index => $image)
                                <div class="col-3 one related-product-one">
                                    <a href="javascript:void(0);">
                                        <img src="{{ url('public/Productupload', $image->product_image) }}"
                                            alt="Related Product 1" class="related-product-img" />
                                    </a>
                                </div>
                            @endforeach
        ...
        <div class="row reviews-details">
            <div class="reviews-point">
                ...
                <div class="review">
                    ...
                    <p class="review-comment">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
